...
import { Building2, Fuel, Wrench, Eye, EyeOff, Copy, Moon, Sun, LogOut, ArrowDownCircle } from "lucide-react";
import { api } from "../api";
import { T } from "../theme";
        ...
        {view === "dashboard" && (
          <div style={{ padding: 16, display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div className={`${t.card} rounded-2xl p-4 border ${t.bdr}`}>
              ...
              {[
                ["Your share (50%)", "GH₵" + (stats.totalRevenue * 0.5).toFixed(0), "#16a34a"],
                ["Driver earnings (25%)", "GH₵" + (stats.totalRevenue * 0.1).toFixed(0), "#2563eb"],
                ["Fuel pool (5%)", "GH₵" + (stats.totalRevenue * 0.05).toFixed(0), "#ca8a04"],
                ["Maintenance (5%)", "GH₵" + (stats.totalRevenue * 0.05).toFixed(0), "#ea580c"],
